...
import buildStorybook from './actions/build/storybook';
...
import publishStorybook from './actions/publish/storybook';
...
import startStorybook from './actions/start/storybook';
...
export default async function action(cmd, options) {
  ...
  switch (cmd) {
    case 'build':
      ...
      if (options.platform === 'storybook') return buildStorybook(options);
    ...
    case 'start':
      ...
      if (options.platform === 'storybook') return startStorybook(options);
    ...
    case 'publish':
      ...
      if (options.platform === 'storybook') return publishStorybook(options);
